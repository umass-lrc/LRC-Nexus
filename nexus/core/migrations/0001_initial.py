...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CourseSubject',
            fields=[
                ('short_name', models.CharField(help_text='The short name of the course subject. For example, "COMPSCI" for Computer Science.', max_length=20, primary_key=True, serialize=False, unique=True)),
